...
const styles = StyleSheet.create({
  logCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 10 },
  logCardWarning: { backgroundColor: 'rgba(212,160,26,0.1)', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', gap: 10 },
  ...
  readinessBadge: { backgroundColor: '#141810', borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', borderRadius: 999, paddingVertical: 7, paddingHorizontal: 11, alignSelf: 'flex-start' },
  readinessBadgeWarning: { backgroundColor: 'rgba(212,160,26,0.1)', borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', borderRadius: 999, paddingVertical: 7, paddingHorizontal: 11, alignSelf: 'flex-start' },
  readinessText: { color: '#B5852C', fontSize: 12, fontWeight: '900' },
  readinessTextWarning: { color: '#ffaa44', fontSize: 12, fontWeight: '900' },
  logMetaRow: { flexDirection: 'row', gap: 10, flexWrap: 'wrap' },
  logMeta: { color: '#b8c0b0', fontSize: 12, fontWeight: '800' },
  detailBox: { backgroundColor: '#080c05', borderRadius: 6, padding: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)' },
  detailLabel: { color: '#b8c0b0', fontSize: 11, fontWeight: '900', textTransform: 'uppercase' },
  detailText: { color: '#FFFFFF', fontSize: 13, fontWeight: '800', marginTop: 4 },
  logNotes: { color: '#c4cec0', fontSize: 14, lineHeight: 21 },
  weakLogBox: { backgroundColor: 'rgba(212,160,26,0.1)', borderRadius: 6, padding: 12, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)' },
  weakLogTitle: { color: '#ffaa44', fontSize: 12, fontWeight: '900', textTransform: 'uppercase' },
  weakLogText: { color: '#ffaa44', fontSize: 13, lineHeight: 18, fontWeight: '800', marginTop: 4 },
  ...
  statusWarning: { color: '#ffaa44', fontSize: 12, fontWeight: '900' },
  ...
  improveButton: { backgroundColor: '#ffaa44', borderWidth: 1, borderColor: '#ffaa44', borderRadius: 999, paddingHorizontal: 11, paddingVertical: 7 },
  improveButtonText: { color: '#080c05', fontSize: 12, fontWeight: '900' },
  deleteButton: { borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', borderRadius: 999, paddingHorizontal: 11, paddingVertical: 7 },
  deleteButtonText: { color: '#ffaa44', fontSize: 12, fontWeight: '900' },
