...
const styles = StyleSheet.create({
  ...
  header: { gap: 6 },
  backButton: { borderWidth: 1, borderColor: 'rgba(181,133,44,0.18)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8, alignSelf: 'flex-start', marginBottom: 6 },
  ...
  completionCard: { backgroundColor: '#141810', borderRadius: 6, padding: 14, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', flexDirection: 'row', justifyContent: 'space-between', gap: 12, alignItems: 'center' },
  completionCardWarning: { backgroundColor: 'rgba(212,160,26,0.1)', borderRadius: 6, padding: 14, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', flexDirection: 'row', justifyContent: 'space-between', gap: 12, alignItems: 'center' },
  ...
  completionScoreWarning: { color: '#ffaa44', fontSize: 34, fontWeight: '900' },
  completionText: { color: '#B5852C', fontSize: 13, fontWeight: '900', flex: 1, textAlign: 'right' },
  completionTextWarning: { color: '#ffaa44', fontSize: 13, fontWeight: '900', flex: 1, textAlign: 'right' },
  card: { backgroundColor: '#0c1008', borderRadius: 6, padding: 14, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 10 },
  sectionTitle: { color: '#ffffff', fontSize: 17, fontWeight: '900' },
  templateRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  templateButton: { backgroundColor: '#141810', borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  templateText: { color: '#B5852C', fontSize: 12, fontWeight: '900' },
  categoryRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  categoryButton: { borderWidth: 1, borderColor: 'rgba(181,133,44,0.18)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  ...
  input: { backgroundColor: '#080c05', borderWidth: 1, borderColor: 'rgba(181,133,44,0.18)', borderRadius: 6, paddingHorizontal: 12, paddingVertical: 11, color: '#ffffff', fontSize: 14 },
  notes: { minHeight: 110, textAlignVertical: 'top' },
  noteHelperBox: { backgroundColor: '#080c05', borderRadius: 6, padding: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 5 },
  noteHelperTitle: { color: '#B5852C', fontSize: 12, fontWeight: '900', textTransform: 'uppercase' },
  noteHelperText: { color: '#b8c0b0', fontSize: 13, lineHeight: 19 },
  ...
  noteStarterButtonText: { color: '#080c05', fontSize: 12, fontWeight: '900' },
  warningBox: { backgroundColor: 'rgba(212,160,26,0.1)', borderRadius: 6, padding: 12, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)' },
  warningTitle: { color: '#ffaa44', fontSize: 12, fontWeight: '900', textTransform: 'uppercase' },
  warningText: { color: '#ffaa44', fontSize: 13, lineHeight: 18, fontWeight: '800', marginTop: 4 },
  readyBox: { backgroundColor: '#141810', borderRadius: 6, padding: 10, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)' },
  readyText: { color: '#B5852C', fontSize: 12, fontWeight: '900' },
  saveButton: { backgroundColor: '#B5852C', borderRadius: 6, paddingVertical: 15, alignItems: 'center' },
  saveButtonText: { color: '#080c05', fontSize: 15, fontWeight: '900' },
});
