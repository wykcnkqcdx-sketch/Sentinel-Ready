...
const styles = StyleSheet.create({
  controlsCard: { backgroundColor: '#00253D', borderRadius: 18, padding: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', gap: 10 },
  ...
  searchInput: { backgroundColor: '#000D1A', borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', borderRadius: 14, paddingHorizontal: 12, paddingVertical: 11, color: '#ffffff', fontSize: 14 },
  ...
  chipTextActive: { color: '#000D1A', fontSize: 12, fontWeight: '900' },
  ...
  resultCount: { color: '#8FAEC8', fontSize: 12, fontWeight: '800' },
});
