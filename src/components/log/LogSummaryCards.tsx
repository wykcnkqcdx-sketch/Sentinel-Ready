...
const styles = StyleSheet.create({
  ...
  weakSummaryCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 14, paddingRight: 76, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 12 },
  weakSummaryCardWarning: { backgroundColor: 'rgba(212,160,26,0.1)', borderRadius: 6, padding: 14, paddingRight: 76, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 12 },
