...
const styles = StyleSheet.create({
  ...
  summaryCard: { flex: 1, backgroundColor: '#1E2229', borderRadius: 16, padding: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  summaryCardWarning: { flex: 1, backgroundColor: 'rgba(245,166,35,0.1)', borderRadius: 16, padding: 12, borderWidth: 1, borderColor: 'rgba(245,166,35,0.3)' },
  summaryNumber: { color: '#ffffff', fontSize: 24, fontWeight: '900' },
  summaryNumberWarning: { color: '#F5A623', fontSize: 24, fontWeight: '900' },
  summaryLabel: { color: '#A7ADB8', fontSize: 11, fontWeight: '800', marginTop: 4 },
  summaryLabelWarning: { color: '#F5A623', fontSize: 11, fontWeight: '900', marginTop: 4 },
  weakSummaryCard: { backgroundColor: '#1E2229', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 12 },
  weakSummaryCardWarning: { backgroundColor: 'rgba(245,166,35,0.1)', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: 'rgba(245,166,35,0.3)', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 12 },
  weakSummaryNumber: { color: '#ffffff', fontSize: 24, fontWeight: '900' },
  weakSummaryNumberWarning: { color: '#F5A623', fontSize: 24, fontWeight: '900' },
  weakSummaryLabel: { color: '#A7ADB8', fontSize: 12, fontWeight: '800', marginTop: 4 },
  weakSummaryLabelWarning: { color: '#F5A623', fontSize: 12, fontWeight: '900', marginTop: 4 },
  weakFilterButton: { borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  weakFilterButtonActive: { backgroundColor: '#F5A623', borderWidth: 1, borderColor: '#F5A623', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  weakFilterButtonText: { color: '#c8d8c5', fontSize: 12, fontWeight: '900' },
  weakFilterButtonTextActive: { color: '#0F1115', fontSize: 12, fontWeight: '900' },
});
