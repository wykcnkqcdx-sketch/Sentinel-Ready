...
const styles = StyleSheet.create({
  ...
  saveHeader: { gap: 3 },
  saveKicker: { color: '#FC4C02', fontSize: 10, fontWeight: '900', letterSpacing: 1.4 },
  saveSummary: { color: '#ffffff', fontSize: 13, fontWeight: '900' },
  saveMeta: { color: '#A7ADB8', fontSize: 11, fontWeight: '800' },
  saveGrid: { flexDirection: 'row', gap: 8 },
  saveField: { flex: 1, gap: 4 },
  saveLabel: { color: '#A7ADB8', fontSize: 10, fontWeight: '900' },
  saveInput: {
