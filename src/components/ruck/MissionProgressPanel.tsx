...
const styles = StyleSheet.create({
  ...
  progressLabel: { width: 32, color: '#8FAEC8', fontSize: 9, fontWeight: '900' },
  ...
  progressFillWarn: { height: '100%', backgroundColor: '#D4A01A' },
  progressValue: { width: 34, color: '#ffffff', fontSize: 10, fontWeight: '900', textAlign: 'right' },
  progressHint: { color: '#8FAEC8', fontSize: 11, fontWeight: '800' },
  progressGood: { color: '#B5852C', fontSize: 11, fontWeight: '900' },
  progressWarn: { color: '#D4A01A', fontSize: 11, fontWeight: '900' },
  ...
  riskAmber: { backgroundColor: '#D4A01A' },
  riskRed: { backgroundColor: '#d1493f' },
  riskTextDark: { color: '#000D1A', fontSize: 10, fontWeight: '900' },
  riskTextLight: { color: '#ffffff', fontSize: 10, fontWeight: '900' },
  riskReason: { flex: 1, color: '#8FAEC8', fontSize: 11, fontWeight: '800' },
  ...
  alertInfo: { backgroundColor: '#00253D', borderColor: 'rgba(181,133,44,0.3)' },
  alertWarning: { backgroundColor: 'rgba(212,160,26,0.1)', borderColor: 'rgba(212,160,26,0.3)' },
