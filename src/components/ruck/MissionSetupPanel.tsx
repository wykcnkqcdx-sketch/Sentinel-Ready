...
const styles = StyleSheet.create({
  ...
  missionText: { color: '#8FAEC8', fontSize: 11, fontWeight: '800' },
  ...
  presetText: { color: '#B5852C', fontSize: 11, fontWeight: '900' },
  presetTextActive: { color: '#000D1A' },
  missionGrid: { flexDirection: 'row', gap: 8 },
  missionField: { flex: 1, gap: 4 },
  missionLabel: { color: '#8FAEC8', fontSize: 9, fontWeight: '900' },
  missionInput: {
