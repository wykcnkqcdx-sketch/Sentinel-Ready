...
const styles = StyleSheet.create({
  ...
  metricCard: { flex: 1, minWidth: 128, borderRadius: 6, padding: 16, backgroundColor: T.bgPanel, borderWidth: 1, borderColor: T.borderSubtle },
  ...
  primaryButton: { minHeight: 52, borderRadius: 6, backgroundColor: T.textAccent, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 8, paddingHorizontal: 18 },
  ...
  routeCard: { borderRadius: 6, padding: 14, backgroundColor: T.bgPanel, borderWidth: 1, borderColor: T.borderSubtle, gap: 8 },
  routePreview: { height: 130, borderRadius: 6, backgroundColor: '#141820', overflow: 'hidden' },
  ...
  chartCard: { borderRadius: 6, padding: 16, backgroundColor: T.bgPanel, borderWidth: 1, borderColor: T.borderSubtle },
