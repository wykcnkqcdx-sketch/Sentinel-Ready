...
export default function TrainingScreen() {
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <Text style={styles.kicker}>CUSTOMIZED TRAINING CYCLE</Text>
...
const styles = StyleSheet.create({
  ...
  briefTitleWarn: { color: DS.warning, fontSize: 20, fontWeight: '900' },
  briefText: { color: DS.textPrimary, fontSize: 13, lineHeight: 20, fontWeight: '800' },
  briefSubText: { color: DS.textSecondary, fontSize: 12, lineHeight: 18 },
  ...
  sectionTitle: { color: DS.textPrimary, fontSize: 20, fontWeight: '900' },
  ...
  miniDayRest: { color: DS.textMuted, fontSize: 13, fontWeight: '900', width: 32 },
  miniFocus: { color: DS.textSecondary, fontSize: 13, fontWeight: '800' },
  miniFocusRest: { color: DS.textMuted, fontSize: 13, fontWeight: '800' },
  miniIntensity: { fontSize: 11, fontWeight: '900' },

  ruleCard: { backgroundColor: DS.bgCardAlt, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: DS.borderHighlight, gap: 6 },
  ruleTitle: { color: DS.textPrimary, fontSize: 15, fontWeight: '900' },
  ruleText: { color: DS.textSecondary, fontSize: 13, lineHeight: 20 },
});
