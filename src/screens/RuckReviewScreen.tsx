...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#8FAEC8', fontSize: 14, fontWeight: '800' },
  ...
  exportButtonText: { color: '#000D1A', fontSize: 13, fontWeight: '900' },
  secondaryExportButton: { alignSelf: 'flex-start', borderWidth: 1, borderColor: '#B5852C', borderRadius: 8, paddingHorizontal: 14, paddingVertical: 10 },
  secondaryExportButtonText: { color: '#B5852C', fontSize: 13, fontWeight: '900' },
  mapFrame: { height: 320, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', overflow: 'hidden', backgroundColor: '#000D1A' },
  statGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  stat: { width: '31%', minWidth: 104, backgroundColor: '#00253D', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', borderRadius: 8, padding: 12, gap: 4 },
  statValue: { color: '#ffffff', fontSize: 18, fontWeight: '900' },
  statLabel: { color: '#8FAEC8', fontSize: 10, fontWeight: '900', textTransform: 'uppercase' },
  card: { backgroundColor: '#00253D', borderRadius: 8, padding: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', gap: 8 },
  warnCard: { backgroundColor: 'rgba(212,160,26,0.1)', borderRadius: 8, padding: 14, borderWidth: 1, borderColor: 'rgba(212,160,26,0.3)', gap: 8 },
  ...
  planLabel: { color: '#8FAEC8', fontSize: 10, fontWeight: '900', textTransform: 'uppercase' },
  planValue: { color: '#ffffff', fontSize: 14, fontWeight: '900' },
  planGood: { color: '#B5852C', fontSize: 11, fontWeight: '900' },
  planWarn: { color: '#D4A01A', fontSize: 11, fontWeight: '900' },
  planMeta: { color: '#8FAEC8', fontSize: 11, fontWeight: '800' },
  safetyAlert: { borderRadius: 8, borderWidth: 1, padding: 10, gap: 4 },
  safetyInfo: { backgroundColor: '#00253D', borderColor: 'rgba(181,133,44,0.3)' },
  safetyWarning: { backgroundColor: 'rgba(212,160,26,0.1)', borderColor: 'rgba(212,160,26,0.3)' },
  ...
  splitText: { color: '#8FAEC8', fontSize: 13, fontWeight: '800' },
  primaryButton: { backgroundColor: '#B5852C', borderRadius: 8, paddingVertical: 13, alignItems: 'center' },
  primaryButtonText: { color: '#000D1A', fontSize: 14, fontWeight: '900' },
});
