...
const styles = StyleSheet.create({
  ...
  backButton: { alignSelf: 'flex-start', borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  backButtonText: { color: '#c8f7d0', fontSize: 13, fontWeight: '900' },
  kicker: { color: '#FC4C02', fontSize: 12, fontWeight: '900', letterSpacing: 2.2 },
  title: { color: '#ffffff', fontSize: 30, fontWeight: '900' },
  subtitle: { color: '#A7ADB8', fontSize: 14, fontWeight: '800' },
  exportRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  exportButton: { alignSelf: 'flex-start', backgroundColor: '#FC4C02', borderRadius: 8, paddingHorizontal: 14, paddingVertical: 10 },
  exportButtonDisabled: { opacity: 0.45 },
  exportButtonText: { color: '#0F1115', fontSize: 13, fontWeight: '900' },
  secondaryExportButton: { alignSelf: 'flex-start', borderWidth: 1, borderColor: '#FC4C02', borderRadius: 8, paddingHorizontal: 14, paddingVertical: 10 },
  secondaryExportButtonText: { color: '#FC4C02', fontSize: 13, fontWeight: '900' },
  mapFrame: { height: 320, borderWidth: 1, borderColor: 'rgba(252,76,2,0.3)', overflow: 'hidden', backgroundColor: '#0F1115' },
  statGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  stat: { width: '31%', minWidth: 104, backgroundColor: '#1E2229', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', borderRadius: 8, padding: 12, gap: 4 },
  statValue: { color: '#ffffff', fontSize: 18, fontWeight: '900' },
  statLabel: { color: '#A7ADB8', fontSize: 10, fontWeight: '900', textTransform: 'uppercase' },
  card: { backgroundColor: '#1E2229', borderRadius: 8, padding: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', gap: 8 },
  warnCard: { backgroundColor: 'rgba(245,166,35,0.1)', borderRadius: 8, padding: 14, borderWidth: 1, borderColor: 'rgba(245,166,35,0.3)', gap: 8 },
  ...
  planLabel: { color: '#A7ADB8', fontSize: 10, fontWeight: '900', textTransform: 'uppercase' },
  planValue: { color: '#ffffff', fontSize: 14, fontWeight: '900' },
  planGood: { color: '#FC4C02', fontSize: 11, fontWeight: '900' },
  planWarn: { color: '#F5A623', fontSize: 11, fontWeight: '900' },
  planMeta: { color: '#A7ADB8', fontSize: 11, fontWeight: '800' },
  safetyAlert: { borderRadius: 8, borderWidth: 1, padding: 10, gap: 4 },
  safetyInfo: { backgroundColor: '#1E2229', borderColor: 'rgba(252,76,2,0.3)' },
  safetyWarning: { backgroundColor: 'rgba(245,166,35,0.1)', borderColor: 'rgba(245,166,35,0.3)' },
  ...
  splitRow: { flexDirection: 'row', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.08)', paddingTop: 8, gap: 10 },
  splitKm: { color: '#ffffff', fontSize: 13, fontWeight: '900' },
  splitText: { color: '#A7ADB8', fontSize: 13, fontWeight: '800' },
  primaryButton: { backgroundColor: '#FC4C02', borderRadius: 8, paddingVertical: 13, alignItems: 'center' },
  primaryButtonText: { color: '#0F1115', fontSize: 14, fontWeight: '900' },
});
