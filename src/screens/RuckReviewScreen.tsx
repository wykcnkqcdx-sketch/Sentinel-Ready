...
const styles = StyleSheet.create({
  ...
  mapFrame: { height: 320, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', overflow: 'hidden', backgroundColor: '#080c05' },
  statGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  stat: { width: '31%', minWidth: 104, backgroundColor: '#0c1008', borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', borderRadius: 8, padding: 12, gap: 4 },
  statValue: { color: '#ffffff', fontSize: 18, fontWeight: '900' },
  statLabel: { color: '#b8c0b0', fontSize: 10, fontWeight: '900', textTransform: 'uppercase' },
  card: { backgroundColor: '#0c1008', borderRadius: 8, padding: 14, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 8 },
  warnCard: { backgroundColor: 'rgba(212,160,26,0.1)', borderRadius: 8, padding: 14, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', gap: 8 },
  ...
  planLabel: { color: '#b8c0b0', fontSize: 10, fontWeight: '900', textTransform: 'uppercase' },
  planValue: { color: '#ffffff', fontSize: 14, fontWeight: '900' },
  planGood: { color: '#B5852C', fontSize: 11, fontWeight: '900' },
  planWarn: { color: '#ffaa44', fontSize: 11, fontWeight: '900' },
  planMeta: { color: '#b8c0b0', fontSize: 11, fontWeight: '800' },
  safetyAlert: { borderRadius: 8, borderWidth: 1, padding: 10, gap: 4 },
  safetyInfo: { backgroundColor: '#0c1008', borderColor: 'rgba(181,133,44,0.3)' },
  safetyWarning: { backgroundColor: 'rgba(212,160,26,0.1)', borderColor: 'rgba(255,170,68,0.3)' },
  ...
  splitRow: { flexDirection: 'row', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: 'rgba(181,133,44,0.12)', paddingTop: 8, gap: 10 },
