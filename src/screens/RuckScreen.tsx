...
const styles = StyleSheet.create({
  ...
  weekRow: { borderTopWidth: 1, borderTopColor: '#203529', paddingTop: 10 },
  weekText: { color: '#91e6a3', fontSize: 12, fontWeight: '900', textAlign: 'center' },

  pbRow: { flexDirection: 'row', gap: 10 },
  pbCard: { flex: 1, backgroundColor: '#0d1812', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: '#203529', gap: 4 },
  ...
  pbDeltaGood: { color: '#91e6a3', fontSize: 11, fontWeight: '900' },
  pbDeltaWarn: { color: '#ffb86b', fontSize: 11, fontWeight: '900' },
  pbDeltaNeutral: { color: '#8fbf8f', fontSize: 11, fontWeight: '800' },
  ...
  emptyHint: { color: '#4a9e6a', fontSize: 12, fontWeight: '900' },
