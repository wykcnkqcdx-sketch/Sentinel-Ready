...
const styles = StyleSheet.create({
  ...
  groupStatLabel: { color: T.textHintDark, fontSize: 7, fontWeight: '900', letterSpacing: 1.5 },
  ...
  sessionHeaderCell: { flex: 1, color: '#2e5038', fontSize: 7, fontWeight: '900', letterSpacing: 1.5 },
