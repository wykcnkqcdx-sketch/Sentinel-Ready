...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#b8c0b0', fontSize: 14, lineHeight: 20 },
  card: {
  ...
  progressText: { color: '#b8c0b0', fontSize: 13, fontWeight: '700' },
  progressTrack: {
    height: 8,
  ...
  cancelButtonText: { color: '#ffaa44', fontSize: 13, fontWeight: '800' },
  downloadButton: {
    backgroundColor: '#B5852C',
    borderRadius: 999,
    paddingVertical: 14,
  ...
  statsLabel: { color: '#b8c0b0', fontSize: 11, fontWeight: '800', textTransform: 'uppercase' },
  clearButton: {
    marginLeft: 'auto',
    borderWidth: 1,
    borderColor: '#e05050',
