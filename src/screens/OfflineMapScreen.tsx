...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#A7ADB8', fontSize: 14, lineHeight: 20 },
  card: {
  ...
  cardLabel: { color: '#FC4C02', fontSize: 11, fontWeight: '900', letterSpacing: 1.5 },
  ...
  pillText: { color: '#FC4C02', fontSize: 13, fontWeight: '800' },
  pillTextActive: { color: '#0F1115', fontSize: 13, fontWeight: '900' },
  progressText: { color: '#A7ADB8', fontSize: 13, fontWeight: '700' },
  progressTrack: {
    height: 8,
  ...
  progressFill: { height: '100%', backgroundColor: '#FC4C02', borderRadius: 999 },
  cancelButton: {
  ...
  cancelButtonText: { color: '#F5A623', fontSize: 13, fontWeight: '800' },
  downloadButton: {
    backgroundColor: '#FC4C02',
    borderRadius: 999,
    paddingVertical: 14,
  ...
  downloadButtonText: { color: '#0F1115', fontSize: 15, fontWeight: '900' },
  statusCard: {
  ...
  statusText: { color: '#FC4C02', fontSize: 13, fontWeight: '700', lineHeight: 20 },
  statsRow: { flexDirection: 'row', alignItems: 'center', gap: 20 },
  statsValue: { color: '#FFFFFF', fontSize: 22, fontWeight: '900' },
  statsLabel: { color: '#A7ADB8', fontSize: 11, fontWeight: '800', textTransform: 'uppercase' },
  clearButton: {
    marginLeft: 'auto',
    borderWidth: 1,
    borderColor: '#FF453A',
  ...
  clearButtonText: { color: '#FF453A', fontSize: 13, fontWeight: '800' },
});
