...
const barStyles = StyleSheet.create({
  track: { height: 5, backgroundColor: '#1a2e22', borderRadius: 3, overflow: 'hidden', flex: 1 },
    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
          ...
          {ruckScore.factors.map(f => (
            <View key={f.label} style={styles.factorRow}>
              ...
              <ScoreBar
                points={f.points}
                max={22}
                colour={f.points >= 14 ? '#91e6a3' : f.points >= 8 ? '#ffb86b' : '#ff8080'}
              />
      ...
      {physicalDomain && (
        <View style={[styles.h2fCard, {
          borderColor: physicalDomain.status === 'GREEN' ? '#2f6b3c'
            : physicalDomain.status === 'AMBER' ? '#7a4a1f'
            : '#7a2020',
        }]}>
          <View style={styles.h2fHeaderRow}>
            ...
            <View style={[styles.h2fBadge, {
              ...
              <Text style={[styles.h2fBadgeText, {
                color: physicalDomain.status === 'GREEN' ? '#91e6a3'
                  : physicalDomain.status === 'AMBER' ? '#ffb86b'
                  : '#ff8080',
...
const styles = StyleSheet.create({
  ...
  controlCard: { backgroundColor: '#0d1812', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#203529', gap: 8 },
  controlSectionLabel: { color: '#91e6a3', fontSize: 11, fontWeight: '900', letterSpacing: 1.4 },
  pillRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  pill: { borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7, backgroundColor: '#1a2e22', borderWidth: 1, borderColor: '#203529' },
  ...
  controlHint: { color: '#4a7a5a', fontSize: 11, marginTop: 4 },

  scoreCard: { backgroundColor: '#102d1a', borderRadius: 18, padding: 18, borderWidth: 1, borderColor: '#2f6b3c', gap: 12 },
  scoreHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  scoreKicker: { color: '#91e6a3', fontSize: 11, fontWeight: '900', letterSpacing: 1.4 },
  scoreBig: { fontSize: 56, fontWeight: '900', lineHeight: 60 },
  scoreRight: { alignItems: 'flex-end', gap: 3 },
  scoreSubLabel: { color: '#8fbf8f', fontSize: 10, fontWeight: '800' },
  scoreSubValue: { color: '#f2f5ef', fontSize: 15, fontWeight: '900' },
  divider: { height: 1, backgroundColor: '#203529' },
  factorRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  factorLeft: { width: 110, gap: 1 },
  factorLabel: { color: '#f2f5ef', fontSize: 12, fontWeight: '800' },
  factorValue: { color: '#8fbf8f', fontSize: 11 },
  factorPoints: { color: '#f2f5ef', fontSize: 13, fontWeight: '900', width: 24, textAlign: 'right' },
  findingText: { color: '#ffb86b', fontSize: 13, fontWeight: '800', lineHeight: 20 },
  recommendationText: { color: '#c4cec0', fontSize: 13, lineHeight: 20 },

  pandolfCard: { backgroundColor: '#0d1812', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#203529', gap: 12 },
  pandolfKicker: { color: '#91e6a3', fontSize: 11, fontWeight: '900', letterSpacing: 1.4 },
  ...
  pandolfLabel: { color: '#8fbf8f', fontSize: 10, fontWeight: '800', textTransform: 'uppercase', textAlign: 'center' },
  pandolfDivider: { width: 1, height: 40, backgroundColor: '#203529' },
  pandolfNote: { color: '#aeb8aa', fontSize: 12, lineHeight: 18, borderTopWidth: 1, borderTopColor: '#203529', paddingTop: 10 },

  h2fCard: { backgroundColor: '#0d1812', borderRadius: 16, padding: 16, borderWidth: 1, gap: 8 },
  h2fHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  h2fKicker: { color: '#91e6a3', fontSize: 11, fontWeight: '900', letterSpacing: 1.4 },
  ...
  h2fDetail: { color: '#aeb8aa', fontSize: 13, lineHeight: 20 },
  ...
  historyRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#0d1812', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#203529' },
  historyLeft: { gap: 3 },
