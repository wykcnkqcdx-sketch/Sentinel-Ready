...
const styles = StyleSheet.create({
  ...
  cardTitle: { color: DS.textPrimary, fontSize: 15, fontWeight: '800' },
  ...
  unitLabel: { color: DS.textSecondary, fontSize: 14, fontWeight: '700' },
  saveHeightBtn: {
  ...
  sectionLabel: { color: DS.gold, fontSize: 11, fontWeight: '900', letterSpacing: 2 },
  statusRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  bigWeight: { color: DS.textPrimary, fontSize: 52, fontWeight: '900', lineHeight: 56 },
  unitSub: { color: DS.textSecondary, fontSize: 14, fontWeight: '700' },
  bmiBlock: { alignItems: 'flex-end', gap: 6 },
  bmiValue: { color: DS.textPrimary, fontSize: 28, fontWeight: '900' },
  bmiStatusBadge: {
    borderWidth: 1,
    borderRadius: 999,
  ...
  skinfoldLine: { color: DS.textSecondary, fontSize: 13, fontWeight: '700' },
  sparkRow: { paddingTop: 4 },
  lastLogged: { color: DS.textSecondary, fontSize: 12, fontWeight: '700' },
  fieldLabel: { color: DS.textSecondary, fontSize: 12, fontWeight: '800', letterSpacing: 1 },
  ...
  stepperBtnText: { color: DS.textPrimary, fontSize: 20, fontWeight: '700' },
  stepperValue: { color: DS.textPrimary, fontSize: 18, fontWeight: '900', minWidth: 80, textAlign: 'center' },
  switchRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  switchLabel: { color: DS.textSecondary, fontSize: 13, fontWeight: '700' },
  notesInput: {
    backgroundColor: '#080c05',
    borderWidth: 1,
    borderColor: DS.bgCardAlt,
  ...
  successMsg: { color: DS.gold, fontSize: 13, fontWeight: '900', textAlign: 'center' },
  bandRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  bandDot: { width: 12, height: 12, borderRadius: 6 },
  bandLabel: { color: DS.textPrimary, fontSize: 13, fontWeight: '800', flex: 1 },
  bandRange: { color: DS.textSecondary, fontSize: 12, fontWeight: '700' },
  hereTag: { color: DS.gold, fontSize: 11, fontWeight: '900' },
  emptyText: { color: DS.textSecondary, fontSize: 13, fontWeight: '700' },
  historyRow: {
    flexDirection: 'row',
    alignItems: 'center',
    ...
    paddingVertical: 8,
    borderBottomWidth: 1,
    borderBottomColor: DS.bgCardAlt,
  },
  historyInfo: { flexDirection: 'row', gap: 10, alignItems: 'center', flexWrap: 'wrap', flex: 1 },
  historyDate: { color: DS.textSecondary, fontSize: 12, fontWeight: '700', minWidth: 90 },
  historyWeight: { color: DS.textPrimary, fontSize: 14, fontWeight: '900' },
  historyBmi: { fontSize: 12, fontWeight: '800' },
  historySkinfold: { color: DS.textSecondary, fontSize: 12, fontWeight: '700' },
  deleteBtn: {
    width: 36,
    height: 36,
    borderRadius: 8,
...
const bc = StyleSheet.create({
  ...
  kicker: { color: DS.gold, fontSize: 11, fontWeight: '900', letterSpacing: 2.5 },
  physBadge: { borderWidth: 1, borderColor: DS.borderHighlight, borderRadius: 4, paddingHorizontal: 8, paddingVertical: 4 },
  physBadgeText: { color: DS.gold, fontSize: 9, fontWeight: '900', letterSpacing: 1 },
});
