...
const styles = StyleSheet.create({
  ...
  loadingScreen: { flex: 1, backgroundColor: DS.bgPrimary, justifyContent: 'center', alignItems: 'center' },
  loadingText: { color: DS.gold, fontSize: 15, fontWeight: '900' },
  ...
  title: { color: DS.goldSoft, fontSize: 32, fontWeight: '900', letterSpacing: -0.8 },
  subtitle: { color: DS.textSecondary, fontSize: 14, lineHeight: 20 },
  topButtonRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  primaryButton: { backgroundColor: DS.gold, borderRadius: 999, paddingVertical: 12, paddingHorizontal: 16 },
  primaryButtonText: { color: '#080c05', fontSize: 13, fontWeight: '900' },
  secondaryButton: { borderWidth: 1, borderColor: DS.gold, borderRadius: 999, paddingVertical: 12, paddingHorizontal: 16 },
  secondaryButtonText: { color: DS.gold, fontSize: 13, fontWeight: '900' },
  infoCard: { backgroundColor: DS.bgCard, borderRadius: 6, padding: 14, borderWidth: 1, borderColor: DS.border, gap: 10 },
  infoCardTitle: { color: DS.textPrimary, fontSize: 15, fontWeight: '900' },
  infoCardText: { color: DS.textSecondary, fontSize: 13 },
  insightRow: { backgroundColor: '#080c05', borderRadius: 12, borderWidth: 1, borderColor: DS.border, padding: 10, gap: 3 },
  insightRowWarn: { backgroundColor: DS.bgWarn, borderRadius: 12, borderWidth: 1, borderColor: DS.borderWarn, padding: 10, gap: 3 },
  insightTitle: { color: DS.textPrimary, fontSize: 13, fontWeight: '900' },
  insightTitleWarn: { color: DS.warning, fontSize: 13, fontWeight: '900' },
  insightText: { color: DS.textSecondary, fontSize: 12, lineHeight: 18 },
  sectionTitle: { color: DS.textPrimary, fontSize: 18, fontWeight: '900', marginTop: 4 },
  emptyCard: { backgroundColor: DS.bgCard, borderRadius: 6, padding: 18, borderWidth: 1, borderColor: DS.border, alignItems: 'flex-start', gap: 8 },
  emptyTitle: { color: DS.textPrimary, fontSize: 20, fontWeight: '900' },
  emptyText: { color: DS.textSecondary, fontSize: 14, lineHeight: 21 },
  emptyButton: { backgroundColor: DS.gold, borderRadius: 999, paddingHorizontal: 14, paddingVertical: 10, marginTop: 4 },
  emptyButtonText: { color: '#080c05', fontSize: 13, fontWeight: '900' },
  fab: { position: 'absolute', bottom: 24, right: 24, backgroundColor: DS.gold, width: 60, height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center', elevation: 5 },
