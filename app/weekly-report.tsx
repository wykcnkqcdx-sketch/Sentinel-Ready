...
const styles = StyleSheet.create({
  ...
  header: { gap: 6 },
  backButton: { borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', borderRadius: 4, paddingHorizontal: 12, paddingVertical: 8, alignSelf: 'flex-start', marginBottom: 6 },
  backButtonText: { color: '#B5852C', fontSize: 13, fontWeight: '900' },
  ...
  thisWeekCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.5)', gap: 12 },
  lastWeekCard: { backgroundColor: '#080c05', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 12 },
  ...
  totalBadge: { backgroundColor: 'rgba(181,133,44,0.12)', borderWidth: 1, borderColor: 'rgba(181,133,44,0.5)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 7 },
  totalBadgeSecondary: { backgroundColor: '#0c1008', borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 7 },
  totalBadgeText: { color: '#B5852C', fontSize: 12, fontWeight: '900' },
  totalBadgeTextSecondary: { color: '#b8c0b0', fontSize: 12, fontWeight: '800' },
  noDataText: { color: '#4a5a44', fontSize: 13, fontWeight: '800' },
  pillRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  pill: { backgroundColor: '#080c05', borderWidth: 1, borderColor: 'rgba(181,133,44,0.5)', borderRadius: 999, paddingHorizontal: 11, paddingVertical: 6 },
  pillWarning: { backgroundColor: 'rgba(255,170,68,0.15)', borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', borderRadius: 999, paddingHorizontal: 11, paddingVertical: 6 },
  pillText: { color: '#B5852C', fontSize: 12, fontWeight: '900' },
  pillTextWarning: { color: '#ffaa44', fontSize: 12, fontWeight: '900' },
  statRow: { flexDirection: 'row', gap: 12 },
  stat: { flex: 1, gap: 3 },
  statNumber: { color: '#FFFFFF', fontSize: 22, fontWeight: '900' },
  statNumberWarning: { color: '#ffaa44', fontSize: 22, fontWeight: '900' },
  statLabel: { color: '#b8c0b0', fontSize: 11, fontWeight: '800' },

  healthCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.5)', gap: 10 },
  healthCardWarning: { backgroundColor: 'rgba(255,170,68,0.1)', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', gap: 10 },
  ...
  healthPill: { backgroundColor: '#080c05', borderRadius: 999, borderWidth: 1, borderColor: 'rgba(181,133,44,0.5)', paddingHorizontal: 12, paddingVertical: 8 },
  healthPillWarning: { backgroundColor: 'rgba(255,170,68,0.15)', borderRadius: 999, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', paddingHorizontal: 12, paddingVertical: 8 },
  ...
  adviceCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 8 },
  adviceCardGood: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.5)', gap: 8 },
  adviceCardWarning: { backgroundColor: 'rgba(255,170,68,0.1)', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', gap: 8 },
  adviceTitle: { color: '#FFFFFF', fontSize: 20, fontWeight: '900' },
  adviceTitleGood: { color: '#B5852C', fontSize: 20, fontWeight: '900' },
  adviceTitleWarning: { color: '#ffaa44', fontSize: 20, fontWeight: '900' },
  adviceText: { color: '#b8c0b0', fontSize: 13, lineHeight: 20 },
  adviceTextWarning: { color: 'rgba(255,170,68,0.8)', fontSize: 13, lineHeight: 20 },
  goalCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.5)', gap: 8 },
  goalTitle: { color: '#FFFFFF', fontSize: 20, fontWeight: '900' },
  goalProgress: { color: '#B5852C', fontSize: 13, fontWeight: '900' },
  goalAction: { color: '#b8c0b0', fontSize: 13, lineHeight: 20, fontWeight: '800' },
  performanceCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 8 },
  recoveryCardWarn: { backgroundColor: 'rgba(255,170,68,0.1)', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(255,170,68,0.3)', gap: 8 },
  recoveryTitleWarn: { color: '#ffaa44', fontSize: 20, fontWeight: '900' },

  exportCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 12 },
  ...
  shareButton: { backgroundColor: '#B5852C', borderRadius: 999, paddingHorizontal: 14, paddingVertical: 10 },
  shareButtonText: { color: '#080c05', fontSize: 13, fontWeight: '900' },
  reportText: { color: '#b8c0b0', backgroundColor: '#080c05', borderRadius: 6, borderWidth: 1, borderColor: 'rgba(181,133,44,0.2)', padding: 12, fontSize: 12, lineHeight: 18, fontFamily: 'monospace' },

  addButton: { backgroundColor: '#B5852C', borderRadius: 6, paddingVertical: 15, alignItems: 'center', marginTop: 4 },
  addButtonText: { color: '#080c05', fontSize: 15, fontWeight: '900' },
});
