...
const styles = StyleSheet.create({
  ...
  thisWeekCard: { backgroundColor: T.bgPanel, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderAccent, gap: 12 },
  lastWeekCard: { backgroundColor: T.bgPanelDark, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderSubtle, gap: 12 },
  ...
  healthCard: { backgroundColor: T.bgPanel, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderAccent, gap: 10 },
  healthCardWarning: { backgroundColor: T.bgWarn, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderWarn, gap: 10 },
  ...
  adviceCard: { backgroundColor: T.bgPanel, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderSubtle, gap: 8 },
  adviceCardGood: { backgroundColor: T.bgPanel, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderAccent, gap: 8 },
  adviceCardWarning: { backgroundColor: T.bgWarn, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderWarn, gap: 8 },
  ...
  goalCard: { backgroundColor: T.bgPanel, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderAccent, gap: 8 },
  ...
  performanceCard: { backgroundColor: T.bgPanel, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderSubtle, gap: 8 },
  recoveryCardWarn: { backgroundColor: T.bgWarn, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderWarn, gap: 8 },
  recoveryTitleWarn: { color: T.textWarn, fontSize: 20, fontWeight: '900' },

  exportCard: { backgroundColor: T.bgPanel, borderRadius: 6, padding: 16, borderWidth: 1, borderColor: T.borderSubtle, gap: 12 },
  ...
  reportText: { color: T.textBodyAlt, backgroundColor: T.bgScreen, borderRadius: 6, borderWidth: 1, borderColor: T.borderField, padding: 12, fontSize: 12, lineHeight: 18, fontFamily: 'monospace' },

  addButton: { backgroundColor: T.textAccent, borderRadius: 6, paddingVertical: 15, alignItems: 'center', marginTop: 4 },
