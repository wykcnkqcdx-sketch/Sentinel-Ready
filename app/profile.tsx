...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#0c1008', borderRadius: 6, padding: 18, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 10 },
  cardKicker: { color: '#B5852C', fontSize: 11, fontWeight: '900', letterSpacing: 1.4 },
  cardLabel: { color: '#b8c0b0', fontSize: 13, lineHeight: 19 },
  inputLabel: { color: '#FFFFFF', fontSize: 12, fontWeight: '900', marginTop: 4 },

  toggleRow: { flexDirection: 'row', gap: 10 },
  toggleBtn: { flex: 1, paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', alignItems: 'center', backgroundColor: '#141810' },
  toggleBtnActive: { flex: 1, paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', alignItems: 'center', backgroundColor: '#141810' },
  toggleText: { color: '#4a5a44', fontSize: 15, fontWeight: '900' },
  toggleTextActive: { color: '#B5852C', fontSize: 15, fontWeight: '900' },

  inputRow: { flexDirection: 'row', gap: 10, alignItems: 'center' },
  input: { flex: 1, backgroundColor: '#080c05', borderRadius: 10, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', color: '#ffffff', fontSize: 16, fontWeight: '800', paddingHorizontal: 14, paddingVertical: 12 },
  notesInput: { minHeight: 80, textAlignVertical: 'top' },
  inputError: { borderColor: 'rgba(204,42,42,0.4)' },
  saveBtn: { backgroundColor: '#141810', borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', borderRadius: 10, paddingHorizontal: 16, paddingVertical: 12 },
  saveBtnText: { color: '#B5852C', fontSize: 14, fontWeight: '900' },
  errorText: { color: '#ffaa44', fontSize: 12, fontWeight: '800' },
  savedRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  savedText: { color: '#b8c0b0', fontSize: 13, fontWeight: '800' },
  clearText: { color: '#ffaa44', fontSize: 13, fontWeight: '900' },
  levelRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  levelBtn: { flexGrow: 1, paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', alignItems: 'center', backgroundColor: '#141810' },
  levelBtnActive: { flexGrow: 1, paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', alignItems: 'center', backgroundColor: '#141810' },
  levelText: { color: '#4a5a44', fontSize: 13, fontWeight: '900' },
  ...
  dataButtonText: { color: '#080c05', fontSize: 14, fontWeight: '900' },

  infoCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 8 },
  ...
  infoLabel: { color: '#b8c0b0', fontSize: 13, fontWeight: '800' },
  infoValue: { color: '#B5852C', fontSize: 13, fontWeight: '900' },
  infoFootnote: { color: '#4a5a44', fontSize: 11, lineHeight: 16, marginTop: 4 },
  milestoneScore: { color: '#ffffff', fontSize: 26, fontWeight: '900' },
  milestoneGrid: { gap: 8 },
  milestoneItem: { backgroundColor: '#080c05', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', padding: 12, gap: 3 },
  milestoneItemEarned: { backgroundColor: '#141810', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', padding: 12, gap: 3 },
  milestoneTitle: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' },
  milestoneTitleEarned: { color: '#B5852C', fontSize: 13, fontWeight: '900' },
  milestoneDescription: { color: '#b8c0b0', fontSize: 12, lineHeight: 17 },
});
