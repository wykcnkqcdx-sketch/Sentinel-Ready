...
const styles = StyleSheet.create({
  ...
  backText: { color: '#B5852C', fontSize: 14, fontWeight: '900' },
  kicker: { color: '#B5852C', fontSize: 12, fontWeight: '900', letterSpacing: 3 },
  title: { color: '#FFFFFF', fontSize: 30, fontWeight: '900' },
  subtitle: { color: '#8FAEC8', fontSize: 15, lineHeight: 22 },

  card: { backgroundColor: '#00253D', borderRadius: 18, padding: 18, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', gap: 10 },
  cardKicker: { color: '#B5852C', fontSize: 11, fontWeight: '900', letterSpacing: 1.4 },
  cardLabel: { color: '#8FAEC8', fontSize: 13, lineHeight: 19 },
  inputLabel: { color: '#FFFFFF', fontSize: 12, fontWeight: '900', marginTop: 4 },

  toggleRow: { flexDirection: 'row', gap: 10 },
  toggleBtn: { flex: 1, paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', alignItems: 'center', backgroundColor: '#003050' },
  toggleBtnActive: { flex: 1, paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', alignItems: 'center', backgroundColor: '#003050' },
  toggleText: { color: '#4A6070', fontSize: 15, fontWeight: '900' },
  toggleTextActive: { color: '#B5852C', fontSize: 15, fontWeight: '900' },

  inputRow: { flexDirection: 'row', gap: 10, alignItems: 'center' },
  input: { flex: 1, backgroundColor: '#000D1A', borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', color: '#ffffff', fontSize: 16, fontWeight: '800', paddingHorizontal: 14, paddingVertical: 12 },
  notesInput: { minHeight: 80, textAlignVertical: 'top' },
  inputError: { borderColor: 'rgba(204,42,42,0.4)' },
  saveBtn: { backgroundColor: '#003050', borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', borderRadius: 10, paddingHorizontal: 16, paddingVertical: 12 },
  saveBtnText: { color: '#B5852C', fontSize: 14, fontWeight: '900' },
  errorText: { color: '#D4A01A', fontSize: 12, fontWeight: '800' },
  savedRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  savedText: { color: '#8FAEC8', fontSize: 13, fontWeight: '800' },
  clearText: { color: '#D4A01A', fontSize: 13, fontWeight: '900' },
  levelRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  levelBtn: { flexGrow: 1, paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', alignItems: 'center', backgroundColor: '#003050' },
  levelBtnActive: { flexGrow: 1, paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', alignItems: 'center', backgroundColor: '#003050' },
  levelText: { color: '#4A6070', fontSize: 13, fontWeight: '900' },
  levelTextActive: { color: '#B5852C', fontSize: 13, fontWeight: '900' },
  dataButton: { backgroundColor: '#B5852C', borderRadius: 12, paddingVertical: 13, alignItems: 'center' },
  dataButtonText: { color: '#000D1A', fontSize: 14, fontWeight: '900' },

  infoCard: { backgroundColor: '#00253D', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', gap: 8 },
  ...
  infoLabel: { color: '#8FAEC8', fontSize: 13, fontWeight: '800' },
  infoValue: { color: '#B5852C', fontSize: 13, fontWeight: '900' },
  infoFootnote: { color: '#4A6070', fontSize: 11, lineHeight: 16, marginTop: 4 },
  milestoneScore: { color: '#ffffff', fontSize: 26, fontWeight: '900' },
  milestoneGrid: { gap: 8 },
  milestoneItem: { backgroundColor: '#000D1A', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', padding: 12, gap: 3 },
  milestoneItemEarned: { backgroundColor: '#003050', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', padding: 12, gap: 3 },
  milestoneTitle: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' },
  milestoneTitleEarned: { color: '#B5852C', fontSize: 13, fontWeight: '900' },
  milestoneDescription: { color: '#8FAEC8', fontSize: 12, lineHeight: 17 },
});
