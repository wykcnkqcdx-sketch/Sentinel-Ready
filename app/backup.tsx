...
const styles = StyleSheet.create({
  ...
  summaryCard: { backgroundColor: '#102016', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: '#2d6b3f', gap: 12 },
  ...
  card: { backgroundColor: '#0d1812', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: '#203529', gap: 10 },
  dangerCard: { backgroundColor: '#21140b', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: '#7a4a1f', gap: 10 },
  cardKicker: { color: '#91e6a3', fontSize: 11, fontWeight: '900', letterSpacing: 1.4 },
  cardText: { color: '#c4cec0', fontSize: 13, lineHeight: 19 },
  primaryButton: { backgroundColor: '#91e6a3', borderRadius: 6, paddingVertical: 14, alignItems: 'center' },
  primaryButtonText: { color: '#07110c', fontSize: 14, fontWeight: '900' },
  secondaryButton: { borderWidth: 1, borderColor: '#91e6a3', borderRadius: 6, paddingVertical: 14, alignItems: 'center' },
  secondaryButtonText: { color: '#91e6a3', fontSize: 14, fontWeight: '900' },
  buttonRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  dangerButton: { flexGrow: 1, borderWidth: 1, borderColor: '#ffb86b', borderRadius: 6, paddingVertical: 13, paddingHorizontal: 12, alignItems: 'center' },
