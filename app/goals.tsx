...
const styles = StyleSheet.create({
  ...
  actionCard: { backgroundColor: '#0d1812', borderRadius: 18, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.4)', gap: 7 },
  ...
  suggestionItem: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#07110c', borderRadius: 14, borderWidth: 1, borderColor: '#003050', padding: 12 },
  ...
  goalCardComplete: { backgroundColor: '#0a1510', borderRadius: 18, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.4)', gap: 8 },
  ...
  progressTrack: { height: 8, backgroundColor: '#07110c', borderRadius: 999, overflow: 'hidden', borderWidth: 1, borderColor: '#003050' },
