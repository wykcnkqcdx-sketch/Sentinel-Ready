...
const styles = StyleSheet.create({
  ...
  summaryCard: { backgroundColor: '#102016', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: '#2d6b3f', gap: 7 },
  ...
  actionCard: { backgroundColor: '#0d1812', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.4)', gap: 7 },
  actionCardWarning: { backgroundColor: '#21140b', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: '#7a4a1f', gap: 7 },
  ...
  suggestionCard: { backgroundColor: '#0d1812', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: '#203529', gap: 10 },
  suggestionItem: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#07110c', borderRadius: 6, borderWidth: 1, borderColor: '#141810', padding: 12 },
  ...
  formCard: { backgroundColor: '#0d1812', borderRadius: 6, padding: 14, borderWidth: 1, borderColor: '#203529', gap: 10 },
  ...
  input: { backgroundColor: '#07110c', borderWidth: 1, borderColor: '#35523e', borderRadius: 6, paddingHorizontal: 12, paddingVertical: 11, color: '#ffffff', fontSize: 14 },
  notes: { minHeight: 80, textAlignVertical: 'top' },
  saveButton: { backgroundColor: '#91e6a3', borderRadius: 6, paddingVertical: 14, alignItems: 'center' },
  saveButtonText: { color: '#07110c', fontSize: 14, fontWeight: '900' },
  goalCard: { backgroundColor: '#0d1812', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: '#203529', gap: 8 },
  goalCardComplete: { backgroundColor: '#0a1510', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.4)', gap: 8 },
  ...
  progressTrack: { height: 8, backgroundColor: '#07110c', borderRadius: 999, overflow: 'hidden', borderWidth: 1, borderColor: '#141810' },
  progressFill: { height: '100%', backgroundColor: '#91e6a3', borderRadius: 999 },
  statusPill: { backgroundColor: '#001829', borderWidth: 1, borderColor: 'rgba(181,133,44,0.4)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 7 },
