...
const styles = StyleSheet.create({
  ...
  backButton: { borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', borderRadius: 4, paddingHorizontal: 12, paddingVertical: 8, alignSelf: 'flex-start' },
  ...
  summaryCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', gap: 7 },
  ...
  summaryProgress: { color: '#B5852C', fontSize: 13, fontWeight: '900' },
  summaryText: { color: '#b8c0b0', fontSize: 13, lineHeight: 20 },
  actionCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.4)', gap: 7 },
  actionCardWarning: { backgroundColor: 'rgba(224,80,80,0.08)', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(224,80,80,0.3)', gap: 7 },
  actionTitle: { color: '#ffffff', fontSize: 20, fontWeight: '900' },
  actionTitleWarning: { color: '#ffaa44', fontSize: 20, fontWeight: '900' },
  actionText: { color: '#b8c0b0', fontSize: 13, lineHeight: 20, fontWeight: '800' },
  suggestionCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 10 },
  suggestionItem: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#080c05', borderRadius: 6, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', padding: 12 },
  suggestionTextBlock: { flex: 1, gap: 3 },
  suggestionTitle: { color: '#ffffff', fontSize: 15, fontWeight: '900' },
  suggestionReason: { color: '#B5852C', fontSize: 11, fontWeight: '900' },
  suggestionTarget: { color: '#b8c0b0', fontSize: 12, lineHeight: 18 },
  suggestionButton: { backgroundColor: '#B5852C', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 9 },
  suggestionButtonText: { color: '#080c05', fontSize: 12, fontWeight: '900' },
  formCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 14, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 10 },
  categoryRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  categoryButton: { borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  categoryActive: { backgroundColor: '#B5852C', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  categoryText: { color: '#b8c0b0', fontSize: 12, fontWeight: '900' },
  categoryTextActive: { color: '#080c05', fontSize: 12, fontWeight: '900' },
  input: { backgroundColor: '#080c05', borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', borderRadius: 6, paddingHorizontal: 12, paddingVertical: 11, color: '#ffffff', fontSize: 14 },
  notes: { minHeight: 80, textAlignVertical: 'top' },
  saveButton: { backgroundColor: '#B5852C', borderRadius: 6, paddingVertical: 14, alignItems: 'center' },
  saveButtonText: { color: '#080c05', fontSize: 14, fontWeight: '900' },
  goalCard: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.12)', gap: 8 },
  goalCardComplete: { backgroundColor: '#0c1008', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: 'rgba(181,133,44,0.4)', gap: 8 },
  goalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 },
  goalTitleBlock: { flex: 1 },
  goalKicker: { color: '#B5852C', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 },
  goalTitle: { color: '#ffffff', fontSize: 18, fontWeight: '900', marginTop: 3 },
  goalTitleComplete: { color: '#B5852C', fontSize: 18, fontWeight: '900', marginTop: 3 },
  goalText: { color: '#b8c0b0', fontSize: 13, lineHeight: 19, fontWeight: '800' },
  goalSubText: { color: '#B5852C', fontSize: 12, lineHeight: 18 },
  progressBlock: { gap: 6, marginTop: 2 },
  progressHeader: { flexDirection: 'row', justifyContent: 'space-between', gap: 10 },
  progressLabel: { color: '#B5852C', fontSize: 11, fontWeight: '900', textTransform: 'uppercase' },
  progressValue: { color: '#b8c0b0', fontSize: 11, fontWeight: '900', flex: 1, textAlign: 'right' },
  progressTrack: { height: 8, backgroundColor: '#080c05', borderRadius: 999, overflow: 'hidden', borderWidth: 1, borderColor: '#080c05' },
  progressFill: { height: '100%', backgroundColor: '#B5852C', borderRadius: 999 },
  statusPill: { backgroundColor: '#080c05', borderWidth: 1, borderColor: 'rgba(181,133,44,0.4)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 7 },
  statusPillComplete: { backgroundColor: 'rgba(94,122,47,0.2)', borderWidth: 1, borderColor: '#5E7A2F', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 7 },
  statusText: { color: '#B5852C', fontSize: 11, fontWeight: '900' },
  statusTextComplete: { color: '#FFFFFF', fontSize: 11, fontWeight: '900' },
  goalActions: { flexDirection: 'row', gap: 8, marginTop: 4 },
  smallButton: { borderWidth: 1, borderColor: 'rgba(181,133,44,0.3)', borderRadius: 4, paddingHorizontal: 12, paddingVertical: 8 },
  smallButtonText: { color: '#B5852C', fontSize: 12, fontWeight: '900' },
  smallButtonDanger: { borderWidth: 1, borderColor: 'rgba(224,80,80,0.3)', borderRadius: 4, paddingHorizontal: 12, paddingVertical: 8 },
  smallButtonDangerText: { color: '#e05050', fontSize: 12, fontWeight: '900' },
});
