...
const styles = StyleSheet.create({
  ...
  requirementsCard: { backgroundColor: '#102016', borderRadius: 6, padding: 16, borderWidth: 1, borderColor: '#2d6b3f', gap: 7 },
  ...
  editorCard: { backgroundColor: '#0d1812', borderRadius: 6, padding: 14, borderWidth: 1, borderColor: '#203529', gap: 10 },
  ...
  csvInput: { minHeight: 260, backgroundColor: '#07110c', borderWidth: 1, borderColor: '#35523e', borderRadius: 6, paddingHorizontal: 12, paddingVertical: 11, color: '#ffffff', fontSize: 12, lineHeight: 18, textAlignVertical: 'top', fontFamily: 'monospace' },
  importButton: { backgroundColor: '#91e6a3', borderRadius: 6, paddingVertical: 15, alignItems: 'center' },
  importButtonDisabled: { backgroundColor: '#35523e', borderRadius: 6, paddingVertical: 15, alignItems: 'center' },
